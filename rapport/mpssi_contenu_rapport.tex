...
\begin{equation}
w(e) = \begin{cases}
1{,}0 & \text{si } code \in \{401, 422\} \quad \text{(authentification échouée / force brute)} \\
0{,}7 & \text{si } code = 403 \quad \text{(accès interdit / exploration de ressources)} \\
0{,}5 & \text{si } code = 429 \quad \text{(dépassement de quota / abus de débit)} \\
